    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center px-6 pt-32 pb-20 bg-[#0A0E14] border-b border-[#232838]">
      <div className="relative z-10 max-w-4xl text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="mb-8 font-mono text-xs md:text-sm tracking-widest text-[#2E8B74] font-semibold uppercase"
        >
        ...
        <motion.h1
          ...
          className="font-display font-extrabold text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-[#EDEDE7] tracking-tighter leading-none mb-8"
        >
          {t("hero_title")}
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-base sm:text-xl text-[#8B92A0] max-w-2xl font-normal leading-relaxed mb-10"
        >
        ...
        <motion.p
          ...
          className="font-mono text-xs text-[#8B92A0] max-w-lg mb-12 italic"
        >
          "{t("hero_intro")}"
        </motion.p>
